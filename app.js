...
function render() {
  ...
  monthWorkoutCount.textContent = `${uniqueDateCount(monthEntries)}회`;
...
function renderHistory() {
  ...
  historyCount.textContent = `${uniqueDateCount(entries)}일`;
...
function uniqueDateCount(items) {
  return uniqueDates(items).size;
}
